            ...
            <div class="card h-100">
              <div class="row h-100">
                <div class="col-4 image-column position-relative">
                  <img class="img-fluid extension_image w-100 pe-3" src="{$category.spotlight_extension.screenshot_src}">
                </div>
        ...
        <div class="col-md-6 col-sm-12 align-self-stretch highest-rated">
            ...
            <div class="col-12 pb-5 h-100">
              <div class="card h-100">
                <div class="row h-100">
                  <div class="col-4 image-column position-relative">
                    <img class="img-fluid extension_image w-100 pe-3" src="{$category.highest_rated_extension.screenshot_src}">
                  </div>
                  <div class="col-8 d-flex info-column align-content-between flex-wrap">
                    <div class="col-12">
        ...
        <div class="col-md-6 col-sm-12 align-self-stretch most-downloaded">
            ...
            <div class="col-12 pb-5 h-100">
              <div class="card h-100">
                <div class="row h-100">
                  <div class="col-4 image-column position-relative">
                    <img class="img-fluid extension_image w-100 pe-3" src="{$category.most_downloaded_extension.screenshot_src}">
                  </div>
                  <div class="col-8 d-flex info-column align-content-between flex-wrap">
                    <div class="col-12">
        ...
        <div class="col-md-6 col-sm-12 align-self-stretch most-recent">
            ...
            <div class="col-12 pb-5 h-100">
              <div class="card h-100">
                <div class="row h-100">
                  <div class="col-4 image-column position-relative">
                    <img class="img-fluid extension_image w-100 pe-3" src="{$category.most_recent_extension.screenshot_src}">
                  </div>
                  <div class="col-8 d-flex info-column align-content-between flex-wrap">
                    <div class="col-12">
