      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            ...
            <button type="button" class="btn btn-outline-secondary small-btn me-3" data-bs-dismiss="modal">{'Cancel'|translate}</button>
            <button type="button" class="btn btn-danger small-btn" onclick="deleteExtension({$extension_id},'{$PEM_ROOT_URL}/index.php?uid={$owner_id}' )">{'Yes, delete'|translate}</button>
          </div>
        </div>
      </div>
    </div>
